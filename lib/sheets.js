...
function getSheetsClient() {
  requireEnv(SPREADSHEET_ID, 'GOOGLE_SHEET_ID');
  requireEnv(SERVICE_ACCOUNT_EMAIL, 'GOOGLE_SERVICE_ACCOUNT_EMAIL');
  requireEnv(SERVICE_ACCOUNT_PRIVATE_KEY, 'GOOGLE_SERVICE_ACCOUNT_PRIVATE_KEY');
